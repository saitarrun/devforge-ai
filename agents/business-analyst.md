...
Read `./projects/<feature-name>/docs/01-grill-summary.md` first. This file contains:
...
Read `./projects/<feature-name>/docs/01-grill-summary.md` (MANDATORY) and product roadmap from the product manager. Extract:
...
Write a `./projects/<feature-name>/docs/01-requirements.md` file with:
...
- **Output**: Save to `./projects/<feature-name>/docs/01-requirements.md` + create GitHub issues
