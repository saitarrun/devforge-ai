...
Read `./projects/<feature-name>/docs/01-grill-summary.md` first. This contains:
...
- Read `./projects/<feature-name>/docs/01-grill-summary.md` (MANDATORY - customer constraints, personas, success metrics)
- Read `./projects/<feature-name>/docs/01-requirements.md` (stories, business rules grounded in grill-me)
...
Write `./projects/<feature-name>/docs/01-architecture.md` with:
...
- **Read**: Parse requirements from `./projects/<feature-name>/docs/01-requirements.md`
...
- **Output**: Save to `./projects/<feature-name>/docs/01-architecture.md` + `./projects/<feature-name>/docs/ARCHITECTURE.mmd`
